...
public interface ScheduleService {
    ...
    //根据剧目Id和时间范围获取相应演出计划
    List<Schedule> selectScheduleByPlayIdDate(Integer id,String start,String end);
    ...
    //根据剧目Id获取当天剩余演出计划（VIP版）
    List<Schedule> selectTodayLeastSchedulesForVip(Integer id);
