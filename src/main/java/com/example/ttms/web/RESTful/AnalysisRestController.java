...
public class AnalysisRestController {
    ...
    //根据员工id获取未完成的订单
    @RequestMapping(value = "/selectCancelSaleByEmployeeId",method = RequestMethod.GET)
    public ResponseResult selectCancelSaleByEmployeeId(@RequestParam("id") Integer id){
        List<Sale> sales = saleService.selectCancelSaleByEmployeeId(id);
        if(sales == null){
            return new ResponseResult(false,"没有任何数据");
        }else{
